...
<!-- <center> -->
<!-- ![ [Data analysis pipeline](http://r4ds.had.co.nz/introduction.html#what-you-will-learn) ](../img/tidy.png) -->
...
aic_plot <- function(){
  aic.plot <-  uk_performance %>% 
    ...
    # geom_point(size = 9, fill = "white",shape = 21, aes(col = minAIC)) +
    # stat_summary(geom = "text",
    #              fun.y = function(x){min(x,na.rm=T)*1.3  + 2},
    #              label = round(uk_performance$adj.r.squared,3), aes(group = id_model)) +
